...
public class Magpie4
{
    ...
    private String transformIYouStatement(String statement)
    {
        ...
        int positionOfYou = findKeyword (statement, "you", positionOfI );
    ...
    private String getRandomResponse()
    {
        ...
        String [] randomResponse = new String[NUMBER_OF_RESPONSES];

        randomResponse[0] = "Interesting, tell me more.";
        randomResponse[1] = "Hmmm.";
        randomResponse[2] = "Do you really think so?";
        randomResponse[3] = "You don't say.";
        randomResponse[4] = "That's neat.";
        randomResponse[5] = "How about that.";
